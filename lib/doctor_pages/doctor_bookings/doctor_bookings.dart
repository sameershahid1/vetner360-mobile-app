...
class _DoctorBookingsState extends State<DoctorBookings> {
  ...
  List date = ["May 22, 2023 - 10.00 AM","Jube 14, 2023 - 15.00pm","June 21, 2023 - 10.00 AM"];
  List img = [
    DoctorPngimage.d1,
    DoctorPngimage.d3,
    DoctorPngimage.d4,
  ...
  List date1 = ["March 12, 2023 - 11.00 AM","March 2, 2023 - 12.00 AM","Feb 2, 2023 - 9.00 AM"];
  List img1 = [
    DoctorPngimage.d2,
    DoctorPngimage.d5,
    DoctorPngimage.d4,
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("My_Bookings".tr,style: isemibold.copyWith(fontSize: 20,color: themedata.isdark?DoctorColor.white:DoctorColor.black),),
          bottom: TabBar(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ClipRRect(
                                        borderRadius: BorderRadius.circular(12),
                                        child: Image.asset(img[index],height: height/7,width: height/7,fit: BoxFit.fill,),
                                      ),
